...
# Background circle - deep navy gradient effect using concentric circles
for i in range(128):
    ratio = i / 128
    r = int(10 + ratio * 20)
    g = int(15 + ratio * 30)
...
draw.rounded_rectangle(
    [mic_x - mic_w // 2, mic_y - mic_h // 2 - 10,
     mic_x + mic_w // 2, mic_y + mic_h // 2 - 10],
    radius=14,
...
for offset in [-8, -3, 2, 7]:
    draw.line(
        [mic_x - mic_w // 2 + 5, mic_y + offset - 10,
         mic_x + mic_w // 2 - 5, mic_y + offset - 10],
...
# Mic stand
stand_y = mic_y + mic_h // 2 - 10
draw.rectangle(
    [mic_x - 2, stand_y, mic_x + 2, stand_y + 16],
    fill=(200, 220, 255, 255)
)

# Mic base
draw.rounded_rectangle(
    [mic_x - 16, stand_y + 13, mic_x + 16, stand_y + 20],
    radius=4,
    fill=(200, 220, 255, 255)
)
...
draw.ellipse(
    [mic_x - 7, mic_y - mic_h // 2 - 6,
     mic_x - 1, mic_y - mic_h // 2 + 2],
...
img.save("/home/claude/whisperpro_icon.png", format="PNG")
print("Icon saved!")
